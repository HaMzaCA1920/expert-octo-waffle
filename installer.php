...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210715_monsite_0982a56b8ce862fa9123_20210715111157_archive.zip';
	const ARCHIVE_SIZE		 = '46781243';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '0982a56-15111157';
    const SECONDARY_PACKAGE_HASH = 'c9cb912-15111157';
	const VERSION			 = '1.4.2';
